...
Quest is organized by practice area:

| Area | Path | Typical contents |
| --- | --- | --- |
| Data Structures and Algorithms | `src/main/data_struct_algo/<topic>/<problem_name>/` | `Problem_Statement.md`, `Code.java`, `Code.cpp`, optional optimized variants |
| Machine Coding | `src/main/machine_coding/<module_name>/` | `Problem_Statement.md`, domain objects, services, demos, tests under `src/test/machine_coding/` |
| System Design | `src/main/system_design/<system_name>/` | `Problem_Statement.md`, `design.excalidraw` |
| Templates | `src/main/resources/template/` | Starter folder structures for new entries |

Use lowercase `snake_case` for topic and problem folders. See [CONTRIBUTING.md](../CONTRIBUTING.md) for contribution conventions and validation expectations.
